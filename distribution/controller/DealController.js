...
var GetDeal_1 = __importDefault(require("../core/use-case/deal/GetDeal"));
...
var DealController = /** @class */ (function () {
    ...
    DealController.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var dealRepositoryMongoDB, getDeal, deals, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        dealRepositoryMongoDB = new DealRepositoryMongoDB_1.default();
                        getDeal = new GetDeal_1.default(dealRepositoryMongoDB);
                        return [4 /*yield*/, getDeal.execute()];
                    case 1:
                        deals = _a.sent();
